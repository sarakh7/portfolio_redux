...
import { addPost, getCats } from '../../../../store/entities/post/postsActions';
import { addPostCanceled } from '../../../../store/entities/post/postsSlice';
...
const CreatePost = () => {
    ...
    const { cats } = useSelector(state => state.posts);
