...
import { updatePricing } from '../../../../services/themeServices';
...
const EditPricing = ({ currentData, showEditForm }) => {
    ...
    return (
        ...
        <>
            <ContentHeader title="Edit Pricings Section" icon={<ArrowLeftOutlined />} btnTitle="Back" action={showEditForm} />
            ...
            <Form
                ...
                onFinish={async (value) => {
                    ...
                    try {
                        const { data, status } = await updatePricing(currentData.id, newValues);
                        if (status === 200) {
                            const newData = [...pricings];
