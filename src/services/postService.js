...
export const getAllGroups = () => {
    const url = `${config.SERVER_URL}/post_cats`;
...
export const getAllPosts = () => {
    const url = `${config.SERVER_URL}/posts`;
    return axios.get(url);
}
...
export const deletePost = (postId) => {
    const url = `${config.SERVER_URL}/posts/${postId}`;
...
export const deleteGroup = (catId) => {
    const url = `${config.SERVER_URL}/post_cats/${catId}`;
    return axios.delete(url);
}
