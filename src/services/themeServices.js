...
export const getAllResumes = () => {
    const url = `${config.SERVER_URL}/resumes`;
...
export const getAllTestimonials = () => {
    const url = `${config.SERVER_URL}/testimonials`;
    return axios.get(url);
}
...
export const getAllClients = () => {
    const url = `${config.SERVER_URL}/clients`;
    return axios.get(url);
}
...
export const getAllClientsSection = () => {
    const url = `${config.SERVER_URL}/clients_sections`;
    return axios.get(url);
}
...
export const getAllPricings = () => {
    const url = `${config.SERVER_URL}/pricings`;
    return axios.get(url);
}
...
export const getAllAbouts = () => {
    const url = `${config.SERVER_URL}/abouts`;
    return axios.get(url);
}
...
export const getGeneral = () => {
    const url = `${config.SERVER_URL}/general`;
    return axios.get(url);
}
...
export const deleteResume = (resumeId) => {
    const url = `${config.SERVER_URL}/resumes/${resumeId}`;
...
export const deleteTestimonial = (testiId) => {
    const url = `${config.SERVER_URL}/testimonials/${testiId}`;
    return axios.delete(url);
}
...
export const deleteClient = (testiId) => {
    const url = `${config.SERVER_URL}/clients/${testiId}`;
    return axios.delete(url);
}
...
export const deleteClientsSection = (csId) => {
    const url = `${config.SERVER_URL}/clients_sections/${csId}`;
    return axios.delete(url);
}
...
export const deletePricing = (pricingId) => {
    const url = `${config.SERVER_URL}/pricings/${pricingId}`;
    return axios.delete(url);
}
...
export const deleteAbout = (aboutId) => {
    const url = `${config.SERVER_URL}/abouts/${aboutId}`;
    return axios.delete(url);
}
...
export const getAllFiles = () => {
    const url = `${config.SERVER_URL}/files`;
    return axios.get(url);
}
...
export const getFileById= (fileId) => {
    const url = `${config.SERVER_URL}/files/${fileId}`;
    return axios.get(url);
}
